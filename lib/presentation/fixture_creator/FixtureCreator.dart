  ...
  void _handleFieldUpdatedToNewValue(String fieldId, String value) {
    setState(() {
      request = request.copyWith(
        ...
        existingValueKeys: Map<String, FieldValueKey>.from(request.existingValueKeys)
          ..removeWhere((key, value) => key == fieldId),
      );
    });
  }

  void _handleFieldUpdatedToExistingValue(String fieldId, FieldValueKey valueKey) {
    setState(() {
      request = request.copyWith(
          newValues: Map<String, String>.from(request.newValues)
            ..removeWhere((key, value) => key == fieldId),
