...
import 'package:darkwrong/redux/reducers/WorksheetNavigationStateReducer.dart';
...
AppState appStateReducer(AppState state, dynamic action) {
  ...
  return state.copyWith(
    ...
    worksheetNavState: worksheetNavigationStateReducer(state.worksheetNavState, action),
  );
}
